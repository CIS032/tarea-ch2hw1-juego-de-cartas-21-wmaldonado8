...
public class Carta {
    ...
    public final static int ESPADAS = 0;   // Códigos para los 4 palos, mas Joker.
    ...
    public final static int JOTA = 11;    //   Las tarjetas de 2 a 10 tienen este codigo
    ...
    * El valor de la tarjeta. Para una carta normal, este es uno de los valores
    ...
    public Carta(int elValor, int elPalo) {
        ...
        if (elPalo != JOTA && (elValor < 1 || elValor > 13))
     ...
     * "3", ..., "10", "Jack", "Queen" o "King". Para un Joker, 
